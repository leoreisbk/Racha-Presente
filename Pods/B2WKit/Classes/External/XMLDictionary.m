...
#import "NSString+GTMNSStringHTMLAddtions.h"
...
{	
	...
	{
        //
        // Remove HTML escaping from attribute dictionary
        //
        NSMutableDictionary *tmpDict = [NSMutableDictionary dictionaryWithDictionary:attributeDict];
        for (int i = 0; i < tmpDict.count; i++)
        {
            NSString *key = [tmpDict allKeys][i];
            tmpDict[key] = [tmpDict[key] gtm_stringByUnescapingFromHTML];
        }
        attributeDict = tmpDict;
