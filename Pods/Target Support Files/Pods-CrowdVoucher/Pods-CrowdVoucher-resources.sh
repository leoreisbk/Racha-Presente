...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_resource "IDMViewControllerStates/Classes/IDMContentUnavailableView.xib"
  install_resource "IDMViewControllerStates/IDMViewControllerStates.bundle"
  ...
  install_resource "${BUILT_PRODUCTS_DIR}/B2WKit.bundle"
fi
